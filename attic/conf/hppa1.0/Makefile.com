...
#
#CONFIGDEFS	= -Dsparc -Drindex=strrchr -Dindex=strchr
CONFIGDEFS	= -Drindex=strrchr -Dindex=strchr
CFLAGS		= -I../../h $(CONFIGDEFS)
LDFLAGS 	= -L/usr/local/lib
MMDFLIBS 	= ../../lib/libmmdf.a
SYSLIBS		= -lgdbm -lbsd -lBSD 
LINT		= lint
...
depend:
	( for i in ${MODULES} ; do \
		${GCC} ${THE_M_FLAG} ${CFLAGS} $$i.c ; done ) | \
	gawk ' { if ($$1 != prev) { print rec; rec = $$0; prev = $$1; } \

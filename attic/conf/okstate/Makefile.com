...
MMPREF		=
LIBDIR		= /local/mmdf
CHANDIR		= /local/mmdf/chans
TBLDIR		= /local/mmdf/table
BINDIR		= /local/bin
RCVDIR		= /local/mmdf/rcvmail

#
#  Defines used during installation
#
INSTALL		= sh ../../installit
CHOWN		= chown
MMDFLOGIN	= mmdf
ROOTLOGIN	= root
PGMPROT 	= 755
...
#
CONFIGDEFS	= -DDEBUG=1 -DSYS5 -DSYS5r3 -DNODUP2 -Drindex=strrchr -Dindex=strchr -DNODOMLIT -DSTATSORT -DNAMESERVER
CFLAGS		= -g -Xo -I../../h $(CONFIGDEFS)
LDFLAGS 	= -L/local/lib
MMDFLIBS 	= ../../lib/libmmdf.a
SYSLIBS		= -ldbm -lsocket -linet -lnsl -lX11 -lseq
LINT		= lint

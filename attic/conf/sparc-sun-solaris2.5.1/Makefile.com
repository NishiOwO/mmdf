...
SERVER_SYSTEM           = 5.4
MMPREF		=
LIBDIR		= /opt/mmdf/lib.sol2
CHANDIR		= /opt/mmdf/chans.sol2
TBLDIR		= /opt/mmdf/table
BINDIR		= /opt/mmdf/bin
RCVDIR		= /opt/mmdf/rcvmail.sol2
...
CONFIGDEFS	= ### -DDOTFORWORD ###
### CFLAGS		= -Dsparc -fwritable-strings -O -I../../h $(CONFIGDEFS)
CFLAGS		= -O -I../../h $(CONFIGDEFS)
LDFLAGS 	=
MMDFLIBS 	= ../../lib/libmmdf.a
ZLIB		= # ../../lib/libz/libz.a
SYSLIBS		= $(ZLIB) # -lresolv -lnsl -lsocket
LINT		= lint
...
LOCALUTIL = tai_file.o lk_lock.5.2.o

...
char *mmtailor = "/var/mmdf/mmdftailor";
				/* location of external tailoring file  */

/* ************************  PUBLIC NAMES  ****************************** */

char
	*locname = "gandalf",  /* Generic name for local host   */

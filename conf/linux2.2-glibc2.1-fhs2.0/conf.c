...
char
	*locname     = "Q",  /* Generic name for local host   */
	*locdomain   = "NET",	/* Name of domain that is local to us */
...
char
	...
	*pathmail = "/usr/bin/v6mail";       /* needs to handle special switches   */
...
int	maxqueue = 600;  /* maximum size of sortable queue       */
int	mailsleep = 100;/* seconds between queue sweeps by a    */
...
char    *Uuxstr = "exec /usr/bin/uux -";		/* command string to start UUX */
char	*Uuname = "youruucpname";

/******************* NIFTP CHANNEL TAILORING  *************************/

char	*pn_quedir   = "/var/spool/jntmail";
...
char	*authrequest = "POSTMASTER@YOUR.MAIL.SITE";

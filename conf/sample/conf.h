...
#define	NUMCHANS   10		/* max number of channels */
#define NUMTABLES  20	/* max number of tables */
#define NUMDOMAINS 5	/* max number of domains */
...
#define	PRIV_USER(x) ((x)==0 || (x)==1 || (x)==11 || (x)==effecid)

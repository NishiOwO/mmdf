...
char
	*locname = "news",/* Generic name for local host          */
	*locdomain = "uni-kl.de",
				/* Name of domain that is local to us */
...
char
	...
	*sysdlvfile = "/opt/mmdf/system.maildelivery",
				/* if non-zero, the default dlvfile */
	*mldfldir = "/opt/mmdf/mailboxes",
				/* directory to contain users' file     */
				/* for receiving local mail.  if this   */
				/* spec is empty, recipient's login     */
				/* directory will be used.              */
	*mldflfil = (char *) 0, /* file to receive new mail             */

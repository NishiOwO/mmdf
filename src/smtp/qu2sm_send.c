...
/** 
 *
 * $Id: qu2sm_send.c,v 1.8 2003/03/02 17:58:48 krueger Exp $
 *
 **/
/*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*/
 ...
 * @brief   overall mngmt for batch of msgs
 **/
/*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*/
int qu2sm_send ()
{
  ...
  for(;;) {
    ...
    if (rp_gval(result) == RP_FIO) {          /* Can't open message file */
      ...
      if (rp_gval(result) != RP_OK)      /* Some other error */
		break;
    }
 ...
 * @param   
 * @return  0 on success, -1 on failure
 * @brief   send copy of text per address
 **/
/*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*/
LOCFUN qu2sm_each ()
{
 ...
 * @param   rp
 * @return  0 on success, -1 on failure
 * @brief   copy the text of the message 
 **/
/*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*/
LOCFUN qu2sm_txtcpy (rp)
RP_Buf *rp;
{
  int       len;
  short     result;
